...
public class JFrameSP extends javax.swing.JFrame {
    ...
    private void loadTable() {
        ...
        dtm.setRowCount(0);
//        int sum = index + 5;
//        if(sum > dao.getAllSP().size()) sum = dao.getAllSP().size();
//        if(index == dao.getAllSP().size() - 1) {
//            index = 0;
//            sum = index + 5;
//        }
        for(SanPham sp : dao.getAllSP()){
//            SanPham sp = dao.getAllSP().get(index);
            Object[] ob = {
                sp.getMa(),
                sp.getTen(),
                sp.getMoTa(),
...
//            System.out.println(i +" "+ index);
    ...
    private SanPham getForm() {
        ...
        int dm = cbbDM.getSelectedIndex() + 1;
        int cl = cbbCL.getSelectedIndex() + 1;
        int pl = cbbPL.getSelectedIndex() + 1;
        int th = cbbTH.getSelectedIndex() + 1;
        ...
        int mau = cbbMau.getSelectedIndex() + 1;
        int hinhDang = cbbHD.getSelectedIndex() + 1;
